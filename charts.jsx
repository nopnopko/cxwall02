/* ============ Charts: SVG LineChart (kept) + AntD Progress gauge/donut ============ */
const { Progress } = antd;
...
function LineChart({ series, t, showYesterday = true, showToday = true, showCustom, customLabel }) {
...
// resolve a "var(--x)" string to a concrete color (Progress strokeColor is safest with hex)
...
/* Gauge: AntD dashboard Progress (bottom-open arc) coloured by threshold zone */
function Gauge({ value, min = 0, max = 100, color, display, sub, size = 168 }) {
  ...
  return (
    <div className="gauge-prog">
      <Progress
        ...
        trailColor={resolveColor("var(--panel-2)")}
...
/* Donut: AntD circle Progress coloured by threshold zone */
function Donut({ value, max = 100, color, display, sub, size = 168 }) {
...
Object.assign(window, { LineChart, Gauge, Donut, useMeasure, resolveColor });
